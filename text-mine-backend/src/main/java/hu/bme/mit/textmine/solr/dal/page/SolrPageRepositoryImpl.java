...
public class SolrPageRepositoryImpl implements CustomSolrPageRepository {
    ...
    public List<SolrPage> pagePhraseQuery(String documentId, String phrase) {
        ...
        return this.template.queryForPage("text-mine-page", q, SolrPage.class, RequestMethod.POST).getContent();
    }
    ...
    public SolrPage saveNoCommit(SolrPage entity) {
        this.template.saveBean("text-mine-page", entity, Duration.ofMinutes(10));
        return entity;
    }

    @Override
    public Iterable<SolrPage> saveNoCommit(Collection<SolrPage> entities) {
        this.template.saveBeans("text-mine-page", entities, Duration.ofMinutes(10));
        return entities;
    }

    @Override
    public void commit() {
        this.template.commit("text-mine-page");
    }
    ...
    public Map<String, Integer> mostFrequentShingles(String documentId, int limit) {
        ...
        FacetPage<SolrPage> page = this.template.queryForFacetPage("text-mine-page", q, SolrPage.class,
                RequestMethod.POST);
        ...
        for (PartOfSpeech pos : partsOfSpeech) {
            ...
            Map<String, Integer> terms = this.template.execute(new SolrCallback<Map<String, Integer>>() {
                ...
                public Map<String, Integer> doInSolr(SolrClient solrClient)
                    ...
                    QueryResponse response = solrClient.query("text-mine-page", solrQuery);
