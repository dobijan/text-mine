...
@Component({
    selector: 'app-location-spatial-query',
    templateUrl: './location-spatial-query.component.html',
    styleUrls: ['./location-spatial-query.component.css'],
    encapsulation: ViewEncapsulation.None
})
export class LocationSpatialQueryComponent implements OnInit {

    title: String = 'Spatial Location Query';
    ...
    onSubmit() {
        this.results = null;
        this.locationService.spatialQuery(this.iri, this.radius).subscribe(res => {
