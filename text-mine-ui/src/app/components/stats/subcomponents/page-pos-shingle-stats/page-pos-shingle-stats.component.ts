...
@Component({
  selector: 'app-page-pos-shingle-stats',
  templateUrl: './page-pos-shingle-stats.component.html',
  styleUrls: ['./page-pos-shingle-stats.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class PagePosShingleStatsComponent implements OnInit {

    title: String = 'Page Part of Speech Shingle Stats';
    ...
    onSubmit() {
        this.stats = null;
        this.documentService.getPagePosShingleStats(this.documentId, this.pos, this.limit).subscribe(res => {
